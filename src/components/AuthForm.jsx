      ...
      <div className='min-h-screen  flex '>
        <div className='grid grid-cols-1 lg:grid-cols-12 w-full'>
          ...
          <div className='col-span-12 lg:col-span-5  h-full p-6 space-y-6 bg-white shadow-md hover:shadow-lg rounded-md'>
            <img src={Logo} alt="food-delivery-logo" className='md:mx-[120px]' />
            <div className='md:mx-[120px] items-center h-3/4 mt-24'>
              <div className='text-4xl font-extrabold text-gray-1000 mb-5'>{title}</div>

              <form className='space-y-8'>
                {title === "Login" && <label className='block text-sm font-medium text-gray-500'>
                ...
                <div>
                  ...
                  <div className='relative'>
                    ...
                    />
                    <span className="absolute inset-y-0 right-0 flex items-center pr-3" onClick={handleTogglePassword}>
                      {!showPassword ? <img src={Eye} alt="Eye" /> : <img src={HiddenEye} alt="Hidden Eye" />}
                    </span>
                  </div>
                </div>
                {title === "Login" ? <><div className='flex items-center justify-between'>
            ...
            {title === "Login" ? <div className='text-sm text-gray-500 flex justify-center'>
              Don't have an account?
              <Link to='/signup' className='text-sm text-blue-500'>
                Sign up
              </Link>
            </div> : <div className='text-sm text-gray-500 flex justify-center'>
              Have an account?
